...
calcular2 = function () {
    ...
    nota1 = recuperarFloat("txtNota1");
    if(isNaN(nota1)){
        mostrarTexto("lblError1","SE DEBE PONER UN NUMERO");
        existeError=true;
    }else{
    ...
    nota2 = recuperarFloat("txtNota2");  
    if(isNaN(nota2)){
        mostrarTexto("lblError2","SE DEBE PONER UN NUMERO");
        existeError=true;
    }else{
    ...
    nota3 = recuperarFloat("txtNota3");  
    if(isNaN(nota3)){
        mostrarTexto("lblError3","SE DEBE PONER UN NUMERO");
        existeError=true;
    }else{
...
esNotaValida=function(nota,idComponente){
    ...
    if(isNaN(nota)){
        mostrarTexto(idComponente,"SE DEBE PONER UN NUMERO");
        hayErrores=true;
    }
